        ...
        <header className="flex flex-col justify-center bg-indigo-300 w-full dark:bg-sky-900">
          ...
          <div className="w-full flex flex-col justify-center items-center text-center">
            ...
            <div className="w-full flex justify-evenly mt-20 flex-wrap">
              <div className="w-64 overflow-hidden flex flex-col justify-center items-center border-gray-50 border-2 rounded-xl hover:shadow-3xl">
            ...
            <Link to = "/Profile" className="flex gap-2 items-center border bg-slate-200 border-gray-400 px-6 py-2 my-4 rounded-lg hover:border-gray-600  ">
          {currentUser?( <div><i class="fa-solid fa-palette"></i>
          <span>My Listings</span>
          <i class="fa-solid fa-arrow-right"></i></div>) :( <div><i class="fa-solid fa-palette"></i>
          <span>Sign Up</span>
